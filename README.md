...
Built on Next.js 16 + AI SDK, with Redis Stack for vector search and the A2UI shadcn catalog inlined from the a2ui repo (`catalog/` + `components/ui/`) for LLM-generated UI.
